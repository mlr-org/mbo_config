...
# mean RSNS
pdf("competitors/results/numeric_performance.pdf", width = 10, height = 10)
...
# mean Rank
pdf("competitors/results/numeric_rank.pdf", width = 10, height = 10)
...
# per task RSNS
pdf("competitors/results/numeric_performance_tasks.pdf", width = 8, height = 6.5)
...
# runtimes
pdf("competitors/results/numeric_runtimes.pdf", width = 10, height = 10)
...
pdf("competitors/results/numeric_cd.pdf", width = 10, height = 5)
plotCD(data_final_wide[, list(Ax, HEBO, mlr3mbo, SMAC4HPO, SMAC4BB)], alpha = 0.05, cex = 2)
dev.off()
