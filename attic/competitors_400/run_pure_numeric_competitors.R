...
log_dir = "/glade/derecho/scratch/marcbecker/mbo_config/logs/competitors_pure_numeric"
...
# problems
job_table = readRDS("common/pure_numeric_instances.rds")
...
# hyperqueue commands
cmds = pmap_chr(job_table, function(algorithm, conda_env, python_script, extra, benchmark, scenario, instance, target_variable, direction, budget, id, seed, repl) { 
