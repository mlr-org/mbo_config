...
registry_name = "/glade/derecho/scratch/marcbecker/yahpo_pure_numeric_coordinate_descent_runtime_ncar"
...
addAlgorithm(
  ...
  fun = function(
    ...
    file = file(sprintf("coordinate_descent/logs/pure_numeric/%i_%s.log", id, job$prob.name), open = "wt")
    sink(file)
