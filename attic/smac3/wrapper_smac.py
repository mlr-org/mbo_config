...
def target_function(
    ...
    input_data = {"X": X}
    with tempfile.NamedTemporaryFile(mode="w+", delete=False, dir="/home/marc/repositories/mbo_config/smac3/tmp") as f:
...
def run_smac(
    ...
    output_directory = os.path.join(
        "/home/marc/repositories/mbo_config/smac3/tmp",
...
if __name__ == "__main__":
    ...
    parser.add_argument("--keep_output", action="store_true", help="Keep SMAC output directory after run")
