...
reticulate::use_virtualenv("/glade/u/home/marcbecker/mbo_config/yahpo_venv", required = TRUE)
library(reticulate)
...
design = generate_design_random(search_space, 100)$data

design = design[rep(1:.N, each = 10)]
design[, replication := rep(1:10, times = 100)]
