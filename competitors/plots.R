...
walk(c("numeric", "mixed", "budget_mixed"), function(benchmark) {
  ...
  data_aggr = fread(sprintf("competitors/results/%s_aggr.csv", benchmark), colClasses = c("instance" = "character"))
  ...
  runtimes = fread(sprintf("competitors/results/%s_runtimes.csv", benchmark))
  ...
  # mean rank
  pdf(sprintf("competitors/results/%s_rank.pdf", benchmark), width = 10, height = 10)
  ...
  # per task RSNS
  pdf(sprintf("competitors/results/%s_performance_tasks.pdf", benchmark), width = 8, height = 6.5)
  ...
  # runtimes
  pdf(sprintf("competitors/results/%s_runtimes.pdf", benchmark), width = 10, height = 10)
