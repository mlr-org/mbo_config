...
results_dir = "/glade/derecho/scratch/marcbecker/mbo_config/registries/competitors_numeric_2"
log_dir = "/glade/derecho/scratch/marcbecker/mbo_config/logs/competitors_pure_numeric_2"
...
# problems
job_table = fread("common/pure_numeric_instances.csv", colClasses = c("instance" = "character"))
