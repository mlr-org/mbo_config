con = file("coordinate_descent_mixed.log")
...
state_path = "/glade/derecho/scratch/marcbecker/mixed_intermediate_instance.rds"
...
save_path = "/glade/derecho/scratch/marcbecker/mixed_coordinate_descent.rds"
