...
registry_name = "/glade/derecho/scratch/marcbecker/yahpo_mixed_deps_coordinate_descent_2"
...
objective = ObjectiveRFunDt$new(
  fun = function(
    ...
    xdt_path = "/glade/derecho/scratch/marcbecker/mixed_deps_intermediate_xdt_2.rds"
    job_ids_path = "/glade/derecho/scratch/marcbecker/mixed_deps_intermediate_job_ids_2.rds"
    ...
    job_ids = submit_ncar(job_ids$job.id, reg, template = "pbs_derecho_main.tmpl", n_jobs = 128L, log_dir = "/glade/derecho/scratch/marcbecker/mbo_config/log_nodes_mixed_deps_2")
...
state_path = "/glade/derecho/scratch/marcbecker/mixed_deps_intermediate_instance_2.rds"
...
save_path = "/glade/derecho/scratch/marcbecker/mixed_deps_coordinate_descent_2.rds"
