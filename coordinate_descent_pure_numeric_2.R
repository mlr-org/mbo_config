sink(file = "coordinate_descent_pure_numeric_2.log")
...
registry_name = "/glade/derecho/scratch/marcbecker/yahpo_pure_numeric_coordinate_descent_2"
...
objective = ObjectiveRFunDt$new(
  fun = function(
    ...
    xdt_path = "/glade/derecho/scratch/marcbecker/pure_numeric_intermediate_xdt_2.rds"
    job_ids_path = "/glade/derecho/scratch/marcbecker/pure_numeric_intermediate_job_ids_2.rds"
    ...
    job_ids = submit_ncar(job_ids$job.id, reg, template = "pbs_derecho_main.tmpl", n_jobs = 128L, log_dir = "/glade/derecho/scratch/marcbecker/mbo_config/log_nodes_pure_numeric_2")
...
state_path = "/glade/derecho/scratch/marcbecker/pure_numeric_intermediate_instance_2.rds"
...
save_path = "/glade/derecho/scratch/marcbecker/pure_numeric_coordinate_descent_2.rds"
