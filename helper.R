make_optim_instance = function(instance) {
  ...
  optim_instance = OptimInstanceBatchSingleCrit$new(objective, search_space = benchmark$get_search_space(drop_fidelity_params = TRUE), terminator = trm("evals", n_evals = instance$budget))
  optim_instance
}
