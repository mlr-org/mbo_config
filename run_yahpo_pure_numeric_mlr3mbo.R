...
registry_name = "/glade/derecho/scratch/lschneider/yahpo_pure_numeric_mlr3mbo"
...
# add algorithms
addAlgorithm("mlr3mbo_pure_numeric_configured_2", fun = mlr3mbo_wrapper_pure_numeric)
...
optimizers = data.table(algorithm = c("mlr3mbo_pure_numeric_configured_2"))
