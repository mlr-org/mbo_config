con = file("competitors_mlr3mbo_mixed_budget_variance.log")
...
source("common/mixed_objective_budget.R")

registry_name = "/glade/derecho/scratch/marcbecker/mbo_config/registries/competitors_mlr3mbo_mixed_budget_variance"
...
reg = makeExperimentRegistry(
  ...
  packages = packages,
  source = c("common/mixed_objective_budget.R"),
  seed = 7832
)
